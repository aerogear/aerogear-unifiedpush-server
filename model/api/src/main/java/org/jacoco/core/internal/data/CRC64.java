 ...
 * </ul>
 * originally from org.jacoco.core.internal.data.CRC64.java http://mvnrepository.com/artifact/org.jacoco/org.jacoco.core/0.7.4.201502262128
 */
public enum CRC64 {
;
     ...
     * @return checksum value
     */
    public static long checksum(final String data) {
        return checksum(data.getBytes(StandardCharsets.UTF_8));
    }
}