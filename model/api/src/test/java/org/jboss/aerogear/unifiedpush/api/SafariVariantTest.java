 ...
 */
public class SafariVariantTest {

    private SafariVariant variant;

    @Before
    public void setup() {
        variant = new SafariVariant();
        variant.setDescription("desc");
        variant.setDeveloper("Admin");
        variant.setName("Safari Variant");
        variant.setCertificate("someCert".getBytes());
        variant.setPassphrase("passphrase");
    }

    @Test
    public void SafariValues() {
        ...
        assertThat(variant.getName()).isEqualTo("Safari Variant");

        assertThat(variant.getType()).isEqualTo(VariantType.SAFARI);
