...
const siteConfig = {
  ...
  headerLinks: [
    {doc: 'running', label: 'Documentation'},
    // {doc: 'doc4', label: 'API'},
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} the AeroGear team`,
  ...
  repoUrl: 'https://github.com/aerogear/aerogear-unifiedpush-server',
  markdownPlugins: [
