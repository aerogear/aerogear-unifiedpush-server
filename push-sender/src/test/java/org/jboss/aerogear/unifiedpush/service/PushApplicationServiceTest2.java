...
public class PushApplicationServiceTest2 extends AbstractBaseServiceTest {
    ...
    public static WebArchive archive() {
        return UnifiedPushArchive.forTestClass(PushApplicationServiceTest2.class)
                .withUtils()
                .withMessageModel()
                .withMockito()
                .withMessaging().forServiceTests()
                .withDAOs()
                .withServices()
                .withApi()
                .withUtils()
