...
/**
 * Receives CDI event with {@link MessageHolderWithSubscriptions} payload and dispatches this payload to JMS queue selected by a type of the variant specified in payload.
 *
...
public class MessageHolderWithSubscriptionsProducer extends AbstractJMSMessageProducer {
    ...
    public void queueMessageVariantForProcessing(@Observes @DispatchToQueue MessageHolderWithSubscriptions msg) {
