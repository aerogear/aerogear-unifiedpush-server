...
Access the Push Notification Service section by clicking *Push Notification Service* from the {webapp}. Log in if you are requested to do so.
...
* Click *Create*
* Code snippets for your applications are displayed.  Copy each snippet into the appropriate file in your application 
