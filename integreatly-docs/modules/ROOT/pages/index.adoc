...
Access the Push Notification Service section by clicking *Push Notification Service* under the *All Services* tab from the {webapp}.

* If some applications already exist, they will be displayed so click "Create Application" to go to the Welcome page.  If there are no previous applications, you will be taken directly to the Welcome page.
