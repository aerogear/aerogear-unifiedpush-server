...
class AndroidVariantEndpointSpecification extends Specification {
    ...
    private static final String UPDATED_ANDROID_VARIANT_GOOGLE_KEY = "UPD-IDDASDASDSA"

    private static final String UPDATED_ANDROID_VARIANT_NAME = "UPD-TestAndroidVariant"

    private static final String UPDATED_ANDROID_VARIANT_DESC = "UPD-awesome variant"
    ...
    private static final String NOT_EXISTING_ANDROID_ID = "1234567890b"
