...
import org.jboss.aerogear.connectivity.jpa.dao.SimplePushVariantDao;
import org.jboss.aerogear.connectivity.model.SimplePushVariant;

public class SimplePushVariantDaoImpl extends AbstractGenericDao<SimplePushVariant, String> implements SimplePushVariantDao {
    ...
    public SimplePushVariant findByVariantIDForDeveloper(String variantID, String loginName) {
        return getSingleResultForQuery(createQuery("select t from "+SimplePushVariant.class.getSimpleName()+" t where t.variantID = :variantID and t.developer = :developer")
