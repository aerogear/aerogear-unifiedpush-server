...
public final class Constants {
  ...
  /**
   * Returned when the number of subscriptions per app exceeds the limit of 1M.
   */
  public static final String ERROR_TOPIC_TOO_MANY_SUBSCRIBERS = "too_many_subscribers";

  /**
   * Indicates invalid input parameters.
   */
  public static final String ERROR_TOPIC_INVALID_PARAMETERS = "invalid_parameters";
