...
public final class Message implements Serializable {
    ...
    public static final class Builder {
         ...
         *
         * @param value the collapse key to set
         * @return the current builder session.
         */
         ...
         * @param value the new ttyl to set
         * @return the current builder session.*
         */
     ...
     * @return the current isDryRun value
     */
     ...
     * @return A map of the data being sent
     */
