...
#### _AeroGear UnifiedPush Server_ releases additional functionality while maintaining _AeroGear_ API compatibility:
...
| Build:          | Maven  |
| Documentation:  | [AeroGear Server Documentation](https://github.com/C-B4/omnibus-unifiedpush-server/tree/master/doc) |
|                 | [AeroGear API Documentaion](http://ups.c-b4.com/C-B4-docs/) |
| Issue tracker:  | [JIRA](https://C-B4.atlassian.net/projects/ARB/issues/) |
...
* Follow the steps on the [Installation guide](https://github.com/C-B4/unifiedpush-server/wiki/AeroGear-Installation)
* Run ``sudo unifiedpush-ctl reconfigure``
* Start the server ``sudo unifiedpush-ctl start``

Now go to ``http://localhost/unifiedpush-server`` and enjoy the AeroGear Server.
...
If you found a bug please create a ticket for us on [Issues](https://C-B4.atlassian.net/projects/ARB/issues/) with some steps to reproduce it.
